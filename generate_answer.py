...
def main():
    ...
    with open('/home/sda/xuguangtao/Firefly-master/data/test/NER.jsonl', 'r', encoding='utf8') as f:
        lines = f.readlines()
        new_datas = []
    ...
    with open('/home/sda/xuguangtao/Firefly-master/data/test/NER_answer.jsonl', 'w', encoding='utf8') as f:
        for data in new_datas:
            json.dump(data, f, ensure_ascii=False)
            f.write('\n')
    
    with open('/home/sda/xuguangtao/Firefly-master/data/test/RE.jsonl', 'r', encoding='utf8') as f:
        lines = f.readlines()
        new_datas = []
        for line in tqdm(lines[:200]):
            data = json.loads(line)
            ...
            new_data['label'] = data['conversation'][0]['assistant']
            new_datas.append(new_data)
    with open('/home/sda/xuguangtao/Firefly-master/data/test/RE_answer.jsonl', 'w', encoding='utf8') as f:
        for data in new_datas:
            json.dump(data, f, ensure_ascii=False)
            f.write('\n')
